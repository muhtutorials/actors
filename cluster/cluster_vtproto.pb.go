...
func (m *ActivationRequest) CloneVT() *ActivationRequest {
	...
	r := new(ActivationRequest)
	r.ID = m.ID
	r.Kind = m.Kind
	r.Region = m.Region
	r.TopologyHash = m.TopologyHash
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
	}
...
func (m *ActivationRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.TopologyHash != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.TopologyHash))
		i--
		dAtA[i] = 0x20
	}
	if len(m.Region) > 0 {
...
func (m *ActivationRequest) SizeVT() (n int) {
	...
	if m.TopologyHash != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.TopologyHash))
	}
	n += len(m.unknownFields)
	return n
}
...
func (m *CID) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *Member) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.Kinds = append(m.Kinds, stringValue)
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := protohelpers.Skip(dAtA[iNdEx:])
...
func (m *Members) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *Handshake) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := m.Member.UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *Topology) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Left = append(m.Left, &Member{})
			if err := m.Left[len(m.Left)-1].UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
			...
			m.Blocked = append(m.Blocked, &Member{})
			if err := m.Blocked[len(m.Blocked)-1].UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
...
func (m *ActorInfo) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *ActorTopology) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 1:
			...
			m.Actors = append(m.Actors, &ActorInfo{})
			if err := m.Actors[len(m.Actors)-1].UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *Activation) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *Deactivation) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *ActivationRequest) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *ActivationResponse) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
